...
public class QueryKineticaToCSV extends AbstractQueryKineticaProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        // This allows the processor to work without input while still supporting EL
        ...
        final FlowFile exprEvalFlowFile = inputFlowFile;  // For cleanup
        ...
        try {
            ...
            // Remove the input/temp FlowFile
