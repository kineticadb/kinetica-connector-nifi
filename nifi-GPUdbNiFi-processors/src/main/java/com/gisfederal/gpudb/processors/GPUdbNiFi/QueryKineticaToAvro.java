...
@Tags({"Kinetica", "query", "get", "avro"})
@CapabilityDescription("Queries a Kinetica table or executes a SQL query and outputs the results as "
        + "Apache Avro container format. Supports batching with configurable batch size.")
@WritesAttributes({
...
public class QueryKineticaToAvro extends AbstractProcessor {
    ...
    public static final Relationship REL_SUCCESS = new Relationship.Builder()
            ...
            .description("FlowFiles with query results in Avro format")
            .build();
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            while (hasMore) {
                ...
                getLogger().info("Batch {} - wrote {} Avro records from {} at {}",
    ...
    private void writeAvro(OutputStream out, List<Record> records, Schema schema) throws IOException {
